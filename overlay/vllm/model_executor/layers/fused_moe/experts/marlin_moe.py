...
from ._mimo_whole_k import (
    moe_wna16_marlin_gemm as _mimo_whole_k_gemm,
    verify_parent_source as _verify_mimo_whole_k_parent,
)

_verify_mimo_whole_k_parent(__file__)
...
# Canonicalization adapted from Apache-2.0 vLLM PR #52532 by bxchange.
# https://github.com/vllm-project/vllm/pull/52532
# Original head: e8a07dcccf8e48dd4b9b42a355fc6d5b9db59073
...
def _fused_marlin_moe(
    ...
    intermediate_cache1 = _mimo_whole_k_gemm(
        gate_up_input,
        intermediate_cache1,
        w1,
        bias1,
...
def fused_marlin_moe(
    ...
    # Private diagnostic candidate based on Apache-2.0 vLLM PR #52532.
    # Stabilizes legal within-expert token order, not all batch-size effects.
